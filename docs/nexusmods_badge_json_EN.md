...
<details>
<summary><b>Which One Should You Choose?</b></summary>
...
A real case used in this project: the Nexus Mods logo doesn't exist in
simple-icons, so its vector SVG was recreated by hand (rather than reusing
a base64-encoded PNG found elsewhere) and embedded as `logoSvg`:
